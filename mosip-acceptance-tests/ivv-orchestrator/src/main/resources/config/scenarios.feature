...
Given I user where user action is ADD_User, and user index or master user is dsl-0, and password is Techno@123
And I user where user action is ADD_User, and user index or master user is 0, and password is Techno@123
And I user where user action is ADD_User, and user index or master user is 1, and password is Techno@123 and store result in registration officer 1
...
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 1, and password is Techno@123, and password or details is the saved environment 1 details and store result in environment 1 details
...
And I user where user action is ACTIVATE_ZONEMAPPING, and user index or master user is the saved environment 1 details, and zone mapping activation flag is T
And I user where user action is CREATE_CENTERMAPPING, and user index or master user is the saved environment 1 details, and center index is 1
And I user where user action is ACTIVATE_CENTERMAPPING, and user index or master user is the saved environment 1 details, and user center mapping flag is T
And I write pre req where environment details is the saved environment 1 details, and pre requisite data index is 1
And I user where user action is ADD_User, and user index or master user is 2, and password is Techno@123 and store result in registration officer 2
...
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 2, and password is Techno@123, and password or details is the saved environment 2 details and store result in environment 2 details
...
And I user where user action is ACTIVATE_ZONEMAPPING, and user index or master user is the saved environment 2 details, and zone mapping activation flag is T
And I user where user action is CREATE_CENTERMAPPING, and user index or master user is the saved environment 2 details, and center index is 2
And I user where user action is ACTIVATE_CENTERMAPPING, and user index or master user is the saved environment 2 details, and user center mapping flag is T
...
And I user where user action is ADD_User, and user index or master user is 3, and password is Techno@123 and store result in registration officer 3
...
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 3, and password is Techno@123, and password or details is the saved environment 3 details and store result in environment 3 details
...
And I user where user action is ACTIVATE_ZONEMAPPING, and user index or master user is the saved environment 3 details, and zone mapping activation flag is T
And I user where user action is CREATE_CENTERMAPPING, and user index or master user is the saved environment 3 details, and center index is 3
And I user where user action is ACTIVATE_CENTERMAPPING, and user index or master user is the saved environment 3 details, and user center mapping flag is T
...
And I user where user action is ADD_User_External_Packet, and user index or master user is 4, and password is Techno@123 and store result in external packet environment details
...
And I update pre reg status where status code is 0, and pre-registration id is the saved pre-registration ID, and scenario without pending appointment is valid
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is minor, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is minor, and guardian flag is true, and gender is Male and store result in child persona file path
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male, and missing biometric fields is leftiris, and password is rightIris and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
And I get email by uin where resident uin is uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is UIN_WAIT_TIME
And I get email by uin where resident uin is uin1 and store result in email
And I credential request where uin is uin1, and email is the saved email and store result in credential request ID
And I check credential status where credential request id is the saved credential request ID
And I download card where credential request id is the saved credential request ID
And I update demo or bio details where bio type is iris, and password is face@@finger, and update attributes is 0, and persona file is 0, and parameter 5 is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in new packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved new packet template path and store result in second registration ID
And I post mock mv where registration id is the saved second registration ID, and manual verification decision is REJECTED
And I check status where packet status is REJECTED, and registration id is the saved second registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male, and missing biometric fields is face, and password is leftEye@@rightEye@@rightIndex@@rightLittle@@rightRing@@rightMiddle@@leftIndex@@leftLittle@@leftRing@@leftMiddle@@leftThumb@@rightThumb and store result in persona file path
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male, and missing biometric fields is POA, and password is POI@@POR@@POE@@POB and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is 90
And I update demo or bio details where bio type is face, and password is iris@@finger, and update attributes is 0, and persona file is 0, and parameter 5 is the saved persona file path
And I get packet template where packet type is LOST, and persona file path is the saved persona file path and store result in lost template
And I packetcreator where packet type is LOST, and template path is lost template and store result in packet zip path
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is langcode=eng, and password is residencestatus=NFR, and parameter 5 is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId1 and store result in transaction id1
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId2 and store result in transaction id2
And I bio esignet authentication where device info file is faceDevice, and uin is the saved UIN, and persona file path is the saved persona file path, and uin transaction id is transaction id1, and vid is the saved VID, and vid transaction id is transaction id2
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Iris:Left@@Iris:Right
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId1 and store result in transaction id1
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId2 and store result in transaction id2
And I bio esignet authentication where device info file is leftLittleDevice, and uin is the saved UIN, and persona file path is the saved persona file path, and uin transaction id is transaction id1, and vid is the saved VID, and vid transaction id is transaction id2
And I user info where transaction id is the saved transaction id, and oidc client id is the saved OIDC client ID
And I delete packet data
...
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId1 and store result in transaction id1
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId2 and store result in transaction id2
And I bio esignet authentication where device info file is rightThumbDevice, and uin is the saved UIN, and persona file path is the saved persona file path, and uin transaction id is transaction id1, and vid is the saved VID, and vid transaction id is transaction id2
And I user info where transaction id is the saved transaction id, and oidc client id is the saved OIDC client ID
And I delete packet data
...
And I credential request where uin is the saved UIN, and email is email1 and store result in credential request ID
And I check credential status where credential request id is the saved credential request ID
And I verify notification where notification type is Credential Issuance Status, and email is email1
And I download card where credential request id is the saved credential request ID
And I update demo or bio details where bio type is finger, and password is face, and miss fields is 0, and update attributes is 0, and parameter 5 is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
And I verify notification where notification type is updated, and email is email1
And I wait where wait seconds is UIN_WAIT_TIME
And I generate vid where vid type is Perpetual, and uin is the saved second UIN, and email or phone is email1 and store result in VID
And I verify notification where notification type is Successful Generation of VID, and email is email1
And I wait where wait seconds is 90
...
And I verify notification where notification type is Successful Generation of VID, and email is the saved email
And I wait where wait seconds is 90
And I ekyc otp where UIN ID type is uin, and UIN is the saved second UIN, and VID ID type is vid, and VID is the saved VID, and email is the saved email and store result in ekycData
And I validate kyc data where uin is photo, and persona file path is ekycData
And I delete packet data
...
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId1 and store result in transaction id1
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId2 and store result in transaction id2
And I esignet authentication where uin transaction id is transaction id1, and uin is the saved UIN, and authentication factor is OTP, and email is the saved email, and vid is the saved VID, and vid transaction id is transaction id2
And I user info where transaction id is transaction id1, and oidc client id is the saved OIDC client ID
And I delete packet data
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is 90
And I update demo or bio details where bio type is /*BIO_TYPE*/0, and miss fields is 0, and update attributes is email=test, and persona file is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I verify notification where notification type is UIN Generated, and email is email1
And I wait where wait seconds is UIN_WAIT_TIME
...
And I check status where packet status is PROCESSED, and registration id is child rid2
And I get uin by rid where source registration id is child rid2 and store result in child uin2
And I verify notification where notification type is updated, and email is email1
And I wait where wait seconds is UIN_WAIT_TIME
And I credential request where uin is child uin2, and email is email1 and store result in credential request ID
And I check credential status where credential request id is the saved credential request ID
And I verify notification where notification type is Credential Issuance Status, and email is email1
And I generate vid where vid type is Perpetual, and uin is child uin2, and email or phone is email1 and store result in VID
And I verify notification where notification type is Successful Generation of VID, and email is email1
And I wait where wait seconds is 90
And I demo authentication where demo field is name, and uin is child uin2, and persona file path is the saved child persona file path, and vid is the saved VID
And I delete packet data
...
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
Then I user where user action is ADD_User, and user index or master user is 4, and password is Techno@123 and store result in user4
Then I center where call type is CREATE, and user details is user4, and center index is 4, and center active flag is T and store result in center4
Then I machine where call type is CREATE, and center details is center4, and center index is 4 and store result in external packet environment details
Then I user where user action is DELETE_CENTERMAPPING, and user index or master user is 4, and password is Techno@123, and password or details is the saved external packet environment details and store result in external packet environment details
...
And I user where user action is ACTIVATE_ZONEMAPPING, and user index or master user is the saved external packet environment details, and zone mapping activation flag is T
And I user where user action is CREATE_CENTERMAPPING, and user index or master user is the saved external packet environment details, and center index is 4
And I user where user action is ACTIVATE_CENTERMAPPING, and user index or master user is the saved external packet environment details, and user center mapping flag is T
And I write pre req where environment details is the saved external packet environment details, and pre requisite data index is 4
...
And I packetcreator where packet type is NEW, and template path is template path2 and store result in packet zip path
...
And I user where user action is ADD_User, and user index or master user is 75, and password is Techno@123 and store result in user75
And I center where call type is CREATE, and user details is user75, and center index is 75, and center active flag is T and store result in center75
And I machine where call type is CREATE, and center details is center75, and center index is 75 and store result in details75
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 75, and password is Techno@123, and password or details is details75 and store result in details75
...
And I write pre req where environment details is details75, and pre requisite data index is 75
And I read pre req where pre requisite data index is 75 and store result in details75
And I set context where context key is env_context, and pre-requisite details is details75, and generate private key is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I user where user action is UPDATE_UIN, and user index or master user is 75, and password is Techno@123, and password or details is the saved UIN
And I set context where context key is env_context, and pre-requisite details is details75, and generate private key is false, and put scenario details in context is null, and negative test or signature flag is valid, and password is null/*SUPERVISOR_PASSWORD*/@@valid/*ADD_REGCLIENT_USER_ID*/@@null/*REGCLIENT_PASSWORD*/@@operatorBiometrics_bio_CBEFF@@supervisorBiometrics_bio_CBEFF
...
And I get packet template where packet type is NEW, and persona file path is persona file path1 and store result in template path1
And I packetcreator where packet type is NEW, and template path is template path1 and store result in zip packet path1
And I ridsync where packet type is NEW, and packet zip path is zip packet path1 and store result in rid1
And I packetsync where packet zip path is zip packet path1
And I set context where context key is env_context, and pre-requisite details is details75, and generate private key is false
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
And I get email by uin where resident uin is uin1 and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
Then I check ridstage where registration id is rid1, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
Then I machine where call type is DCOM, and center details is details75
Then I user where user action is DELETE_CENTERMAPPING, and user index or master user is 75, and password is Techno@123, and password or details is details75 and store result in details75
Then I center where call type is DCOM, and user details is details75, and center index is 75
And I delete packet data
...
And I corrupt packet where byte offset is 1024, and data to encode is hello automation, and packet zip path is the saved packet zip path
...
And I get ping health where component is targetenv
And I get resident data where persona type is minor, and guardian flag is true, and gender is Male and store result in child persona file path
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in parent persona1
And I get packet template where packet type is NEW, and persona file path is parent persona1 and store result in parent template1
And I generate and upload packet skipping prereg where persona file path is parent persona1, and packet template path is parent template1 and store result in parent rid1
And I check status where packet status is PROCESSED, and registration id is parent rid1
And I get uin by rid where source registration id is parent rid1 and store result in parent uin1
And I get email by uin where resident uin is parent uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update resident with rid where persona file path is parent persona1, and registration id is parent rid1
And I update resident with guardian skipping pre reg where guardian persona file path is parent persona1, and child persona file path is the saved child persona file path
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in parent persona2
And I get packet template where packet type is NEW, and persona file path is parent persona2 and store result in parent template2
And I generate and upload packet skipping prereg where persona file path is parent persona2, and packet template path is parent template2 and store result in parent rid2
And I check status where packet status is PROCESSED, and registration id is parent rid2
And I get uin by rid where source registration id is parent rid2 and store result in parent uin2
And I get email by uin where resident uin is parent uin2 and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update resident with rid where persona file path is parent persona2, and registration id is parent rid2
And I update resident with guardian skipping pre reg where guardian persona file path is parent persona2, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
And I check status where packet status is PROCESSED, and registration id is the saved child registration ID
And I get uin by rid where source registration id is the saved child registration ID and store result in child UIN
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attribute is email=additionalReqId_51, and persona file is the saved persona file path
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path2
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is email=additionalReqId_51, and persona file is persona file path2
And I get packet template where packet type is BIOMETRIC_CORRECTION, and persona file path is persona file path2 and store result in template path2
And I packetcreator where packet type is BIOMETRIC_CORRECTION, and template path is template path2, and additional info request id is additional req id and store result in zip packet path2
And I ridsync where packet type is BIOMETRIC_CORRECTION, and packet zip path is zip packet path2, and additional info request id is additional req id and store result in second registration ID
And I packetsync where packet zip path is zip packet path2
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in UIN
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key value is qa4_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I skip
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
...
And I validate otp where persona file path is the saved persona file path, and email is the saved email
And I pre register where persona file path is the saved persona file path and store result in pre-registration ID
And I update pre reg status where status code is 0, and pre-registration id is the saved pre-registration ID, and scenario with pending appointment is invalid
And I delete packet data
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in rid1
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in UIN
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update demo or bio details where bio type is leftIris, and password is rigthIris, and miss fields is 0, and update attributes is 0, and parameter 5 is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 2 and store result in environment 2 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 2 details, and generate private key is false, and registration status or invalidation flag is null, and negative test or signature flag is invalid, and password is valid@@valid@@valid
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 3 details, and generate private key is false, and put scenario details in context is null, and negative test or signature flag is valid, and password is invalid/*SUPERVISOR_PASSWORD*/@@valid/*REGCLIENT_USER_ID*/@@valid
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 2 and store result in environment 2 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 2 details, and generate private key is false, and put scenario details in context is null, and negative test or signature flag is valid, and password is valid/*SUPERVISOR_PASSWORD*/@@null/*REGCLIENT_USER_ID*/@@null
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 3 and store result in environment 3 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 3 details, and generate private key is false, and put scenario details in context is null, and negative test or signature flag is valid, and password is valid/*SUPERVISOR_PASSWORD*/@@invalid/*REGCLIENT_USER_ID*/@@valid
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 2 and store result in environment 2 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 2 details, and generate private key is false, and registration status or invalidation flag is null, and negative test or signature flag is valid, and password is valid@@valid@@invalid
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I user where user action is ADD_User, and user index or master user is 2, and password is Techno@123, and password or details is the saved UIN
And I set context where context key is env_context, and pre-requisite details is the saved environment 2 details, and generate private key is false, and put scenario details in context is null, and negative test or signature flag is null@@null@@null@@null@@OperatorBiometrics_bio_CBEFF@@SupervisorBiometrics_bio_CBEFF
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in rid1
And I packetsync where packet zip path is the saved packet zip path
And I check status where packet status is REREGISTER, and registration id is rid1
Then I check ridstage where registration id is rid1, and rid stage is INTERNAL_WORKFLOW_ACTION, and stage status is SUCCESS
And I delete packet data
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I user where user action is ADD_User, and user index or master user is 3, and password is Techno@123, and password or details is the saved UIN
And I set context where context key is env_context, and pre-requisite details is the saved environment 3 details, and generate private key is false, and registration status or invalidation flag is null, and negative test or signature flag is null, and password is null@@null@@null@@null@@null
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
...
And I user where user action is ADD_User, and user index or master user is 76, and password is Techno@123 and store result in user76
And I center where call type is CREATE, and user details is user76, and center index is 76, and center active flag is T and store result in center76
And I machine where call type is CREATE, and center details is center76, and center index is 76 and store result in details76
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 76, and password is Techno@123, and password or details is details76 and store result in details76
...
And I write pre req where environment details is details76, and pre requisite data index is 76
And I read pre req where pre requisite data index is 76 and store result in details76
And I set context where context key is env_context, and pre-requisite details is details76, and generate private key is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I user where user action is UPDATE_UIN, and user index or master user is 76, and password is Techno@123, and password or details is the saved UIN
And I set context where context key is env_context, and pre-requisite details is details76, and generate private key is true, and put scenario details in context is null, and negative test or signature flag is valid, and password is null/*SUPERVISOR_PASSWORD*/@@null/*REGCLIENT_USER_ID*/@@null/*REGCLIENT_PASSWORD*/@@null/*OPERATOR_CBEFF*/@@supervisorBiometrics_bio_CBEFF
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path1
And I get packet template where packet type is NEW, and persona file path is persona file path1 and store result in template path1
And I packetcreator where packet type is NEW, and template path is template path1 and store result in zip packet path1
And I ridsync where packet type is NEW, and packet zip path is zip packet path1 and store result in rid1
...
And I verify notification where notification type is UIN Generated, and email is email1
Then I check ridstage where registration id is rid1, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
Then I machine where call type is DCOM, and center details is details76
Then I user where user action is DELETE_CENTERMAPPING, and user index or master user is 76, and password is Techno@123, and password or details is details76 and store result in details76
Then I center where call type is DCOM, and user details is details76, and center index is 76
And I delete packet data
...
Given I get ping health where component is packetcreator
And I user where user action is ADD_User, and user index or master user is 52, and password is Techno@123 and store result in user52
And I center where call type is CREATE, and user details is user52, and center index is 52, and center active flag is T and store result in center52
And I machine where call type is CREATE, and center details is center52, and center index is 52 and store result in details52
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 52, and password is Techno@123, and password or details is details52 and store result in details52
...
And I write pre req where environment details is details52, and pre requisite data index is 52
And I read pre req where pre requisite data index is 52 and store result in details52
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY, and machine details is details52, and key index is UPPER and store result in key index
And I sync data where call type is CLIENT_SETTINGS_VALID, and machine details is key index, and center index is 52
...
And I sync data where call type is USER_DETAILS, and machine details is details52
And I machine where call type is DCOM, and center details is details52
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 52, and password is Techno@123, and password or details is details52 and store result in details52
And I center where call type is DCOM, and user details is details52, and center index is 52
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 53, and password is Techno@123 and store result in user53
And I center where call type is CREATE, and user details is user53, and center index is 53, and center active flag is T and store result in center53
And I machine where call type is CREATE, and center details is center53, and center index is 53 and store result in details53
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 53, and password is Techno@123, and password or details is details53 and store result in details53
...
And I write pre req where environment details is details53, and pre requisite data index is 53
And I user where user action is ADD_User, and user index or master user is 531, and password is Techno@123 and store result in user531
And I center where call type is CREATE, and user details is user531, and center index is 531, and center active flag is T and store result in center531
And I machine where call type is CREATE, and center details is center531, and center index is 531 and store result in details531
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 531, and password is Techno@123, and password or details is details531 and store result in details531
...
And I write pre req where environment details is details531, and pre requisite data index is 531
And I read pre req where pre requisite data index is 53 and store result in details53
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY, and machine details is details53, and key index is UPPER and store result in key index
And I sync data where call type is CLIENT_SETTINGS_VALID, and machine details is key index, and center index is 53
And I read pre req where pre requisite data index is 531 and store result in details531
And I machine where packet type is UPDATE, and center details is details531, and center index is 531 and store result in details53
And I sync data where call type is CLIENT_SETTINGS_INVALID, and machine details is key index, and center index is 531
And I machine where packet type is UPDATE, and center details is details53, and center index is 53 and store result in details53
And I machine where call type is DCOM, and user details is details531
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 531, and password is Techno@123, and password or details is details531 and store result in details531
And I center where call type is DCOM, and user details is details531, and center index is 531
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 54, and password is Techno@123 and store result in user54
And I center where call type is CREATE, and user details is user54, and center index is 54, and center active flag is T and store result in center54
And I machine where call type is CREATE, and center details is center54, and center index is 54 and store result in details54
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 54, and password is Techno@123, and password or details is details54 and store result in details54
...
And I write pre req where environment details is details54, and pre requisite data index is 54
And I read pre req where pre requisite data index is 54 and store result in details54
And I machine where call type is ACTIVE_FLAG, and center details is details54, and center index is 54, and machine activation flag is F
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY, and machine details is details54, and key index is UPPER and store result in key index
And I sync data where call type is CLIENT_SETTINGS_VALID, and machine details is key index, and center index is 54
And I sync data where call type is CONFIGS_KEYINDEX, and machine details is key index
And I sync data where call type is USER_DETAILS, and machine details is details54
And I machine where call type is ACTIVE_FLAG, and center details is details54, and center index is 54, and machine activation flag is T
And I machine where call type is DCOM, and center details is details54
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 54, and password is Techno@123, and password or details is details54 and store result in details54
And I center where call type is DCOM, and user details is details54, and center index is 54
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 55, and password is Techno@123 and store result in user55
And I center where call type is CREATE, and user details is user55, and center index is 55, and center active flag is T and store result in center55
And I machine where call type is CREATE, and center details is center55, and center index is 55 and store result in details55
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 55, and password is Techno@123, and password or details is details55 and store result in details55
...
And I write pre req where environment details is details55, and pre requisite data index is 55
And I read pre req where pre requisite data index is 55 and store result in details55
And I machine where call type is DCOM, and center details is details55
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY_INVALID, and machine details is details55, and key index is UPPER and store result in key index
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 55, and password is Techno@123, and password or details is details55 and store result in details55
And I center where call type is DCOM, and user details is details55, and center index is 55
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 56, and password is Techno@123 and store result in user56
And I center where call type is CREATE, and user details is user56, and center index is 56, and center active flag is T and store result in center56
And I machine where call type is CREATE, and center details is center56, and center index is 56 and store result in details56
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 56, and password is Techno@123, and password or details is details56 and store result in details56
...
And I write pre req where environment details is details56, and pre requisite data index is 56
And I read pre req where pre requisite data index is 56 and store result in details56
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 56, and password is Techno@123, and password or details is details56 and store result in details56
And I machine where call type is REMOVE_CENTER, and center details is details56
And I center where call type is DCOM, and user details is details56, and center index is 56
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY, and machine details is details56, and key index is UPPER and store result in key index
And I sync data where call type is CONFIGS_KEYINDEX, and machine details is key index
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 57, and password is Techno@123 and store result in user57
And I center where call type is CREATE, and user details is user57, and center index is 57, and center active flag is T and store result in center57
And I machine where call type is CREATE, and center details is center57, and center index is 57 and store result in details57
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 57, and password is Techno@123, and password or details is details57 and store result in details57
...
And I write pre req where environment details is details57, and append key for prerequisite data is 57
And I read pre req where pre requisite data index is 57 and store result in details57
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 57, and password is Techno@123, and password or details is details57 and store result in details57
And I machine where call type is REMOVE_CENTER, and center details is details57
And I center where call type is ACTIVE_FLAG, and user details is details57, and center index is 57, and center active flag is F
And I wait where wait seconds is 9
And I sync data where call type is TPM_VERIFY, and machine details is details57, and key index is UPPER and store result in key index
And I sync data where call type is CONFIGS_KEYINDEX, and machine details is key index
And I sync data where call type is CLIENT_SETTINGS_INVALID, and machine details is key index, and center index is 57
And I machine where call type is DCOM, and center details is details57
And I center where call type is DCOM, and user details is details57, and center index is 57
And I delete packet data
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is 90
And I update demo or bio details where bio type is face, and password is iris, and miss fields is 0, and update attributes is 0, and parameter 5 is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId1 and store result in transaction id1
And I oauth details request where oidc client id is the saved OIDC client ID, and transaction id slot is transactionId2 and store result in transaction id2
And I bio esignet authentication where device info file is faceDevice, and uin is the saved second UIN, and persona file path is the saved persona file path, and uin transaction id is transaction id1, and vid is the saved VID, and vid transaction id is transaction id2
And I user info where transaction id is the saved transaction id, and oidc client id is the saved OIDC client ID
And I delete packet data
...
And I user where user action is ADD_User, and user index or master user is 77, and password is Techno@123 and store result in user77
And I center where call type is CREATE, and user details is user77, and center index is 77, and center active flag is T and store result in center77
And I machine where call type is CREATE, and center details is center77, and center index is 77 and store result in details77
...
And I user where user action is CREATE_CENTERMAPPING, and user index or master user is details77, and center index is 77
...
And I write pre req where environment details is details77, and pre requisite data index is 77
And I read pre req where pre requisite data index is 77 and store result in details77
And I set context where context key is env_context, and pre-requisite details is details77, and generate private key is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I user where user action is UPDATE_UIN, and user index or master user is 77, and password is Techno@123, and password or details is the saved UIN
And I set context where context key is env_context, and pre-requisite details is details77, and generate private key is false, and registration status or invalidation flag is null, and negative test or signature flag is null, and password is null@@valid@@null@@operatorBiometrics_bio_CBEFF@@null
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path1
And I get packet template where packet type is NEW, and persona file path is persona file path1 and store result in template path1
And I packetcreator where packet type is NEW, and template path is template path1 and store result in zip packet path1
And I ridsync where packet type is NEW, and packet zip path is zip packet path1 and store result in rid1
And I packetsync where packet zip path is zip packet path1
And I set context where context key is env_context, and pre-requisite details is details77, and generate private key is false
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
And I get email by uin where resident uin is uin1 and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
Then I check ridstage where registration id is rid1, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
Then I machine where call type is DCOM, and center details is details77
...
Then I center where call type is DCOM, and user details is details77, and center index is 77
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and invalid device certificate is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path2
And I get packet template where packet type is BIOMETRIC_CORRECTION, and persona file path is persona file path2 and store result in template path2
And I packetcreator where packet type is BIOMETRIC_CORRECTION, and template path is template path2, and additional info request id is 11111111111111111111111111111 and store result in zip packet path2
And I ridsync where packet type is BIOMETRIC_CORRECTION, and packet zip path is zip packet path2, and request info for correction packet is 11111111111111111111111111111 and store result in second registration ID
And I packetsync where packet zip path is zip packet path2, and expected to pass flag is false
And I delete packet data
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path3
And I get packet template where packet type is BIOMETRIC_CORRECTION, and persona file path is persona file path3 and store result in template path3
And I packetcreator where packet type is BIOMETRIC_CORRECTION, and template path is template path3, and additional info request id is additional req id and store result in zip packet path3
And I ridsync where packet type is BIOMETRIC_CORRECTION, and packet zip path is zip packet path3, and additional info request id is additional req id and store result in rid3
And I packetsync where packet zip path is zip packet path3
Then I check ridstage where registration id is rid3, and rid stage is SECUREZONE_NOTIFICATION, and stage status is REJECTED
And I delete packet data
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path2
And I get packet template where packet type is BIOMETRIC_CORRECTION, and persona file path is persona file path2, and biometric quality score is 20 and store result in template path2
And I packetcreator where packet type is BIOMETRIC_CORRECTION, and template path is template path2, and additional info request id is additional req id and store result in zip packet path2
And I ridsync where packet type is BIOMETRIC_CORRECTION, and packet zip path is zip packet path2, and additional info request id is additional req id and store result in second registration ID
And I packetsync where packet zip path is zip packet path2
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path3
And I get packet template where packet type is BIOMETRIC_CORRECTION, and persona file path is persona file path3, and biometric quality score is 30 and store result in template path3
And I packetcreator where packet type is BIOMETRIC_CORRECTION, and template path is template path3, and additional info request id is additional req id2 and store result in zip packet path3
And I ridsync where packet type is BIOMETRIC_CORRECTION, and packet zip path is zip packet path3, and additional info request id is additional req id2 and store result in rid3
And I packetsync where packet zip path is zip packet path3
And I check status where packet status is PROCESSED, and registration id is rid3
...
And I post mock mv where registration id is child rid2, and manual verification decision is REJECTED
And I check status where packet status is REJECTED, and registration id is child rid2
And I delete packet data
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and registration status or invalidation flag is null, and password is 99
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in template path new
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update resident with uin where persona file path is the saved parent persona file path, and uin is the saved parent UIN
And I get resident data where persona type is minor, and guardian flag is true, and gender is Male, and password is false/*FINGER_BIOMETRIC_FLAG*/@@false/*IRIS_BIOMETRIC_FLAG*/@@false and store result in child persona file path
And I update resident with guardian skipping pre reg where guardian persona file path is the saved parent persona file path, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
And I check status where packet status is REREGISTER, and registration id is the saved child registration ID
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update resident with uin where persona file path is the saved parent persona file path, and uin is the saved parent UIN
And I get resident data where persona type is infant, and guardian flag is true, and gender is Male, and password is false/*FINGER_BIOMETRIC_FLAG*/@@false/*IRIS_BIOMETRIC_FLAG*/@@true and store result in child persona file path
And I update resident with guardian skipping pre reg where guardian persona file path is the saved parent persona file path, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
And I check status where packet status is PROCESSED, and registration id is the saved child registration ID
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update resident with uin where persona file path is the saved parent persona file path, and uin is the saved parent UIN
And I get resident data where persona type is infant, and guardian flag is true, and gender is Male, and password is false/*FINGER_BIOMETRIC_FLAG*/@@false/*IRIS_BIOMETRIC_FLAG*/@@false and store result in child persona file path
And I update resident with guardian skipping pre reg where guardian persona file path is the saved parent persona file path, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
Then I check ridstage where registration id is the saved child registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
And I wait where wait seconds is 90
And I demo authentication where demo field is name, and uin is the saved child UIN, and persona file path is the saved child persona file path, and vid is vidwithoutotp
And I bio authentication where device info file is faceDevice, and uin is the saved child UIN, and vid is vidwithoutotp, and persona file path is the saved child persona file path
And I bio authentication where device info file is LeftIris, and uin is the saved child UIN, and vid is vidwithoutotp, and persona file path is the saved child persona file path
And I bio authentication where device info file is leftRingDevice, and uin is the saved child UIN, and vid is vidwithoutotp, and persona file path is the saved child persona file path
And I otp authentication where uin is the saved UIN, and vid is the saved child UIN, and email is the saved VID, and parameter 4 is vidwithoutotp, and parameter 5 is the saved email
And I delete packet data
...
Then I generate vidwithout otp where vid type is Perpetual, and uin is the saved child UIN and store result in vidwithoutotp
Then I wait where wait seconds is UIN_WAIT_TIME
Then I demo authentication where demo field is name, and uin is the saved child UIN, and persona file path is the saved child persona file path, and vid is vidwithoutotp
And I delete packet data
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is 90
And I update demo or bio details where bio type is face@@iris@@finger, and miss fields is 0, and update attributes is 0, and persona file is the saved persona file path
And I get packet template where packet type is LOST, and persona file path is the saved persona file path and store result in lost template
And I packetcreator where packet type is LOST, and template path is lost template and store result in packet zip path
And I ridsync where packet type is LOST, and packet zip path is the saved packet zip path and store result in rid lost
And I packetsync where packet zip path is the saved packet zip path
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is true, and gender is Male, and password is false/*FINGER_BIOMETRIC_FLAG*/@@false/*IRIS_BIOMETRIC_FLAG*/@@true and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is INTRODUCER_VALIDATION, and stage status is ERROR
...
Then I generate vidwithout otp where vid type is Perpetual, and uin is the saved child UIN and store result in vidwithoutotp
And I wait where wait seconds is 90
And I ekyc demo where demo field is name, and uin is the saved child UIN, and persona file path is the saved child persona file path, and vid is vidwithoutotp and store result in ekycData
And I validate kyc data where uin is photo, and persona file path is ekycData
And I delete packet data
...
And I check credential status where credential request id is the saved credential request ID
And I demo authentication where demo field is name, and uin is lost uin, and persona file path is the saved persona file path, and vid is vidwithoutotp
And I delete packet data
...
And I generate vidwithout otp where vid type is Perpetual, and uin is lost uin and store result in vidwithoutotp
And I wait where wait seconds is 90
And I bio authentication where device info file is faceDevice, and uin is lost uin, and vid is vidwithoutotp, and persona file path is the saved persona file path
And I delete packet data
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is true, and gender is Male and store result in child persona file path
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in parent persona file path
And I get packet template where packet type is NEW, and persona file path is the saved parent persona file path and store result in parent packet template path
And I generate and upload packet skipping prereg where persona file path is the saved parent persona file path, and packet template path is the saved parent packet template path and store result in parent registration ID
And I check status where packet status is PROCESSED, and registration id is the saved parent registration ID
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path, and biometric quality score is 80, and generate valid cbeff flag is false and store result in packet template path
...
And I update demo or bio details where bio type is face, and password is iris@@finger, and update attributes is 0, and update attributes is 0, and parameter 5 is the saved persona file path
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger@@Iris:Left
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in parent persona file path
And I update bio exception in persona where persona file path is the saved parent persona file path, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger@@Iris:Left
And I get packet template where packet type is NEW, and persona file path is the saved parent persona file path and store result in parent packet template path
And I generate and upload packet skipping prereg where persona file path is the saved parent persona file path, and packet template path is the saved parent packet template path and store result in parent registration ID
And I check status where packet status is PROCESSED, and registration id is the saved parent registration ID
And I get uin by rid where source registration id is the saved parent registration ID and store result in parent UIN
...
And I update resident with uin where persona file path is the saved parent persona file path, and uin is the saved parent UIN
And I get resident data where persona type is minor, and guardian flag is true, and gender is Male and store result in child persona file path
And I update bio exception in persona where persona file path is the saved child persona file path, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger@@Iris:Left
And I update resident with guardian skipping pre reg where guardian persona file path is the saved parent persona file path, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
And I check status where packet status is PROCESSED, and registration id is the saved child registration ID
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left Thumb@@Finger:Left IndexFinger@@Finger:Left MiddleFinger@@Finger:Left RingFinger@@Finger:Left LittleFinger@@Finger:Right Thumb@@Finger:Right IndexFinger@@Finger:Right MiddleFinger@@Finger:Right RingFinger@@Finger:Right LittleFinger@@Iris:Left@@Iris:Right
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I check tags where registration id is the saved registration ID
...
And I update resident with uin where persona file path is the saved parent persona file path, and uin is the saved parent UIN
And I get resident data where persona type is minor, and guardian flag is true, and gender is Male and store result in child persona file path
And I update bio exception in persona where persona file path is the saved child persona file path, and biometric exception modalities is Finger:Left Thumb@@Finger:Left IndexFinger@@Finger:Left MiddleFinger@@Finger:Left RingFinger@@Finger:Left LittleFinger@@Finger:Right Thumb@@Finger:Right IndexFinger@@Finger:Right MiddleFinger@@Finger:Right RingFinger@@Finger:Right LittleFinger@@Iris:Left@@Iris:Right
And I update resident with guardian skipping pre reg where guardian persona file path is the saved parent persona file path, and child persona file path is the saved child persona file path
And I get packet template where packet type is NEW, and persona file path is the saved child persona file path and store result in child packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved child packet template path and store result in child registration ID
And I check status where packet status is PROCESSED, and registration id is the saved child registration ID
...
And I verify notification where notification type is UIN Generated, and email is the saved email
And I wait where wait seconds is 90
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is addressLine1=bnglr@@phoneNumber=3938333736, and persona file is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is LOST, and persona file path is the saved persona file path and store result in lost template
And I packetcreator where packet type is LOST, and template path is lost template and store result in packet zip path
And I ridsync where packet type is LOST, and packet zip path is the saved packet zip path and store result in rid lost
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get blocklisted word where call type is CREATE, and blocklist type is dslautomation and store result in blocklisted word
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is phoneNumber=, and password is email=, and parameter 5 is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update demo or bio details where bio type is iris, and password is finger, and update attributes is 0, and update attributes is 0, and parameter 5 is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
And I verify notification where notification type is updated, and email is the saved email
And I check for bdbabsence where uin is the saved second UIN, and biometric modalities is IRIS_Left, and password is IRIS_Right
And I delete packet data
...
And I verify notification where notification type is UIN Generated, and email is the saved email
Then I check ridstage where registration id is the saved registration ID, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
Then I check for bdbpresence where uin is the saved registration ID, and biometric modalities is FINGER_Left RingFinger, and password is FINGER_Right LittleFinger@@FACE@@FINGER_Left LittleFinger@@IRIS_Right@@FINGER_Left MiddleFinger@@FINGER_Left IndexFinger@@FINGER_Right IndexFinger@@IRIS_Left@@FINGER_Right RingFinger@@FINGER_Left Thumb@@FINGER_Right MiddleFinger@@FINGER_Right Thumb, and parameter 4 is false/EXCEPTION_FLAG/
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false/GENERATE_PRIVATE_KEY/, and put scenario details in context is null, and consent flag is yes
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and put scenario details in context is null, and consent flag is no
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I user where user action is ADD_User, and user index or master user is 6, and password is Techno@123 and store result in user6
And I center where call type is CREATE, and user details is user6, and center index is 6, and center active flag is T and store result in center6
And I machine where call type is CREATE, and center details is center6, and center index is 6 and store result in details6
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 6, and password is Techno@123, and password or details is details6 and store result in details6
...
And I write pre req where environment details is details6, and pre requisite data index is 6
And I read pre req where pre requisite data index is 6 and store result in details6
And I set context where context key is env_context, and pre-requisite details is details6, and generate private key is true
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I machine where call type is REMOVE_CENTER, and center details is center6, and center index is 6
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 6, and password is Techno@123, and password or details is details6 and store result in details6
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
And I packetsync where packet zip path is the saved packet zip path
...
Given I user where user action is ADD_User, and user index or master user is 7, and password is Techno@123 and store result in user7
And I center where call type is CREATE, and user details is user7, and center index is 7, and center active flag is T and store result in center7
And I machine where call type is CREATE, and center details is center7, and center index is 7 and store result in details7
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 7, and password is Techno@123, and password or details is details7 and store result in details7
...
And I write pre req where environment details is details7, and pre requisite data index is 7
And I read pre req where pre requisite data index is 7 and store result in details7
And I set context where context key is env_context, and pre-requisite details is details7, and generate private key is true
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I machine where call type is REMOVE_CENTER, and center details is center7, and center index is 7
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 7, and password is Techno@123, and password or details is details7 and store result in details7
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
And I packetsync where packet zip path is the saved packet zip path
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and put scenario details in context is null, and consent flag is null, and switch case for supervisor name is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where age category is senior, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
And I check status where packet status is PROCESSED, and registration id is child rid1
And I get uin by rid where source registration id is child rid1 and store result in child uin1
And I get email by uin where resident uin is child uin1 and store result in second email
And I verify notification where notification type is UIN Generated, and email is the saved second email
Then I check ridstage where registration id is child rid1, and rid stage is INTRODUCER_VALIDATION, and stage status is SUCCESS
Then I check ridstage where registration id is child rid1, and rid stage is VERIFICATION, and stage status is SUCCESS
...
Then I check ridstage where registration id is child rid2, and rid stage is INTRODUCER_VALIDATION, and stage status is SUCCESS
Then I check ridstage where registration id is child rid2, and rid stage is VERIFICATION, and stage status is SUCCESS
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and put scenario details in context is null, and consent flag is null, and switch case for supervisor name is null, and invalid encrypted hash flag is invalidEncryptedHash
And I get ping health where component is targetenv
And I get resident data where age category is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and put scenario details in context is null, and consent flag is null, and switch case for supervisor name is null, and upload packet invalid encrypted hash flag is null, and invalid checksum flag is invalidCheckSum
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
And I packetsync where packet zip path is the saved packet zip path, and expected to pass flag is false
And I delete packet data
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is template path1 and store result in rid1
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
And I check tags where registration id is rid1
And I get email by uin where resident uin is uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
Then I check ridstage where registration id is rid1, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
And I delete packet data
...
Given I user where user action is ADD_User, and user index or master user is 156, and password is Techno@123 and store result in user156
And I center where call type is CREATE, and user details is user156, and center index is 156, and center active flag is T and store result in center156
And I machine where call type is CREATE, and center details is center156, and center index is 156 and store result in details156
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 156, and password is Techno@123, and password or details is details156 and store result in details156
...
And I write pre req where environment details is details156, and pre requisite data index is 156
And I read pre req where append key to read prerequisite data is 156 and store result in details156
And I set context where context key is env_context, and pre-requisite details is details156, and generate private key is true
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 156, and password is Techno@123, and password or details is details156 and store result in details156
And I machine where call type is REMOVE_CENTER, and center details is details156
And I center where call type is ACTIVE_FLAG, and user details is details156, and center index is 156, and center active flag is F
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
And I packetsync where packet zip path is the saved packet zip path
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
Then I machine where call type is DCOM, and center details is details156
Then I center where call type is DCOM, and user details is details156, and center index is 156
And I delete packet data
...
Given I user where user action is ADD_User, and user index or master user is 8, and password is Techno@123 and store result in user8
And I center where call type is CREATE, and user details is user8, and center index is 8, and center active flag is T and store result in center8
And I machine where call type is CREATE, and center details is center8, and center index is 8 and store result in details8
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 8, and password is Techno@123, and password or details is details8 and store result in details8
...
And I write pre req where environment details is details8, and pre requisite data index is 8
And I read pre req where append key to read prerequisite data is 8 and store result in details8
And I set context where context key is env_context, and pre-requisite details is details8, and generate private key is true
And I machine where call type is ACTIVE_FLAG, and center details is details8, and machine index is 8, and machine active flag is F
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
And I ridsync where packet type is NEW, and packet zip path is the saved packet zip path and store result in registration ID
And I packetsync where packet zip path is the saved packet zip path
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
Then I machine where call type is DCOM, and center details is details8
Then I user where user action is DELETE_CENTERMAPPING, and user index or master user is 8, and password is Techno@123, and password or details is details8 and store result in details8
Then I center where call type is DCOM, and user details is details8, and center index is 8
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and invalid schema version is invalidIdSchema
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is 1, and password is 2, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and skip bio classification flag is skipBiometricClassification
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and skip applicant documents flag is skipApplicantDocuments
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I verify notification where notification type is Successful Generation of VID, and email is the saved email
And I wait where wait seconds is 90
And I demo authentication where demo field is age, and uin is the saved UIN, and persona file path is the saved persona file path, and vid is the saved VID, and age decrement flag is ageDecrease
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and invalid packet creation date is invalidCreationDate
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path1
And I get packet template where packet type is NEW, and persona file path is persona file path1 and store result in template path1
And I generate and upload packet skipping prereg where persona file path is persona file path1, and packet template path is template path1 and store result in rid1
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
And I get email by uin where resident uin is uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and registration status or invalidation flag is null, and password is 99
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path2
And I get packet template where packet type is NEW, and persona file path is persona file path2 and store result in template path2
And I generate and upload packet skipping prereg where persona file path is persona file path2, and packet template path is template path2 and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
And I get email by uin where resident uin is the saved second UIN and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is face, and password is finger@@iris, and update attributes is 0, and update attributes is 0, and persona to update is persona file path1, and persona to update with is persona file path2
And I update resident with uin where persona file path is persona file path1, and uin is the saved second UIN
And I get packet template where packet type is UPDATE, and persona file path is persona file path1 and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is persona file path1, and packet template path is the saved update packet template path and store result in rid3
And I check status where packet status is PROCESSED, and registration id is rid3
And I get uin by rid where source registration id is rid3 and store result in uin3
And I verify notification where notification type is updated, and email is the saved email
And I delete packet data
...
And I get email by uin where resident uin is the saved second UIN and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is iris, and miss fields is 0, and update attributes is 0, and persona to update is persona file path1, and persona to update with is persona file path2
And I update resident with uin where persona file path is persona file path1, and uin is the saved second UIN
And I get packet template where packet type is UPDATE, and persona file path is persona file path1 and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is persona file path1, and packet template path is the saved update packet template path and store result in rid3
And I check status where packet status is PROCESSED, and registration id is rid3
...
And I get email by uin where resident uin is the saved UIN and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is face, and password is finger@@iris, and update attributes is 0, and update attributes is 0, and persona to update is the saved child persona file path, and persona to update with is the saved persona file path
...
And I get email by uin where resident uin is the saved UIN and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is face, and miss fields is 0, and update attributes is 0, and persona to update is the saved child persona file path, and persona to update with is the saved persona file path
And I update resident with uin where persona file path is the saved child persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved child persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is the saved update packet template path and store result in rid1
And I check status where packet status is PROCESSED, and registration id is rid1
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and invalid packet creation date is invalidOfficerID
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get email by uin where resident uin is uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update demo or bio details where bio type is iris, and password is finger, and update attributes is 0, and update attributes is 0, and persona to update is the saved persona file path
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left Thumb@@Finger:Left IndexFinger@@Finger:Left MiddleFinger@@Finger:Left RingFinger@@Finger:Left LittleFinger@@Finger:Right Thumb@@Finger:Right IndexFinger@@Finger:Right MiddleFinger@@Finger:Right RingFinger@@Finger:Right LittleFinger
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in rid1
And I check status where packet status is PROCESSED, and registration id is rid1
And I get uin by rid where source registration id is rid1 and store result in uin1
...
And I get email by uin where resident uin is uin1 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update demo or bio details where bio type is finger, and password is iris, and update attributes is 0, and update attributes is 0, and persona to update is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is uin1
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and registration status or invalidation flag is null, and password is 99
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path2
And I update bio exception in persona where persona file path is persona file path2, and biometric exception modalities is Finger:Left IndexFinger@@Finger:Right IndexFinger@@Iris:Left
And I get packet template where packet type is NEW, and persona file path is persona file path2 and store result in template path2
And I generate and upload packet skipping prereg where persona file path is persona file path2, and packet template path is template path2 and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
...
And I get uin by rid where source registration id is rid3 and store result in uin3
And I verify notification where notification type is updated, and email is the saved email
Then I check ridstage where registration id is rid3, and rid stage is PRINT_SERVICE, and stage status is PROCESSED
Then I check updated uin where parameter 1 is uin1, and parameter 2 is uin3
And I delete packet data
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path2
And I get packet template where packet type is NEW, and persona file path is persona file path2 and store result in template path2
And I generate and upload packet skipping prereg where persona file path is persona file path2, and packet template path is template path2 and store result in rid4
And I check status where packet status is PROCESSED, and registration id is rid4
And I get uin by rid where source registration id is rid4 and store result in uin4
And I get email by uin where resident uin is uin4 and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is finger, and miss fields is 0, and update attributes is 0, and persona file is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is uin4
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
...
And I check status where packet status is PROCESSED, and registration id is rid5
And I get uin by rid where source registration id is rid5 and store result in uin5
And I verify notification where notification type is updated, and email is the saved email
Then I check ridstage where registration id is rid5, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
And I delete packet data
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template3 and store result in rid3
And I post mock mv where registration id is rid3, and manual verification decision is PROCESSED
And I check status where packet status is PROCESSED, and registration id is rid3
And I get uin by rid where source registration id is rid3 and store result in uin3
And I get email by uin where resident uin is uin3 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I get bio modality hash where persona ID is -1, and modality subtypes is Right IndexFinger@@Left LittleFinger, and persona path is the saved persona file path and store result in modality hash value
And I update resident with uin where persona file path is the saved persona file path, and uin is uin1
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template4 and store result in rid4
And I check status where packet status is PROCESSED, and registration id is rid4
And I get uin by rid where source registration id is rid4 and store result in uin4
And I verify notification where notification type is updated, and email is the saved email
Then I check ridstage where registration id is rid4, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
Then I check updated uin where parameter 1 is uin1, and parameter 2 is uin4
And I delete packet data
...
And I post mock mv where registration id is the saved second registration ID, and manual verification decision is REJECTED
And I check status where packet status is REJECTED, and registration id is the saved second registration ID
And I update demo or bio details where bio type is iris, and password is finger, and update attributes is 0, and persona file is 0, and parameter 5 is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is uin1
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in rid3
And I check status where packet status is PROCESSED, and registration id is rid3
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Left Thumb@@Finger:Right Thumb
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
...
Then I update demo or bio details where bio type is face, and password is iris@@finger, and update attributes is 0, and update attributes is 0, and parameter 5 is the saved child persona file path
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 4 and store result in external packet environment details
And I set context where context key is env_context, and pre-requisite details is the saved external packet environment details, and generate private key is false, and packet type is EXTERNAL
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is false, and gender is Female and store result in persona file path
And I create and upload external packet where source is CRVS1, and packet type is CRVS_NEW, and parameter 3 is the saved persona file path and store result in registration ID
...
And I wait where wait seconds is UIN_WAIT_TIME
And I get email by uin where resident uin is the saved UIN and store result in email1
And I generate vid where vid type is Perpetual, and uin is the saved UIN, and email or phone is email1 and store result in VID
And I verify notification where notification type is Successful Generation of VID, and email is email1
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is name, and persona file is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved VID
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is rid2
And I demo authentication where demo field is name, and uin is the saved UIN, and persona file path is the saved persona file path, and vid is the saved VID
And I delete packet data
...
Given I get ping health where component is packetcreator
And I user where user action is ADD_User, and user index or master user is 5, and password is Techno@123 and store result in user5
And I center where call type is CREATE, and user details is user5, and center index is 5, and center active flag is T and store result in center5
And I machine where call type is CREATE, and center details is center5, and center index is 5 and store result in details5
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 5, and password is Techno@123, and password or details is details5 and store result in details5
...
And I write pre req where environment details is details5, and pre requisite data index is 5
And I read pre req where pre requisite data index is 5 and store result in details5
And I set context where context key is env_context, and pre-requisite details is the saved environment 5 details, and generate private key is true, and registration status or invalidation flag is 0, and negative test or signature flag is invalidSignature
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is false, and gender is Female and store result in persona file path
And I create and upload external packet where source is CRVS1, and packet type is CRVS_NEW, and parameter 3 is the saved persona file path, and introducerinfotoken is true and store result in registration ID
And I sync external packet where packet zip path is the saved registration ID
And I check status where packet status is PROCESSED, and registration id is the saved registration ID
And I get uin by rid where source registration id is the saved registration ID and store result in UIN
And I get email by uin where resident uin is the saved UIN and store result in email
...
And I read pre req where pre requisite data index is 4 and store result in external packet environment details
And I set context where context key is env_context, and pre-requisite details is the saved external packet environment details, and generate private key is false, and packet type is EXTERNAL
And I create and upload external packet where source is CRVS1, and packet type is CRVS_DEATH, and parameter 3 is the saved persona file path, and infotoken is true, and parameter 5 is the saved UIN and store result in second registration ID
...
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is false, and gender is Female and store result in persona file path
And I create and upload external packet where source is CRVS11@invalid, and packet type is CRVS_NEW1, and parameter 3 is the saved persona file path and store result in registration ID
And I delete packet data
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 4 and store result in external packet environment details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and packet type is EXTERNAL
And I get ping health where component is targetenv
And I get resident data where persona type is infant, and guardian flag is false, and gender is Female and store result in persona file path
...
And I write pre req where environment details is details5, and pre requisite data index is 5
And I read pre req where pre requisite data index is 5 and store result in details5
And I set context where context key is env_context, and pre-requisite details is details5, and generate private key is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
And I read pre req where pre requisite data index is 4 and store result in external packet environment details
And I set context where context key is env_context, and pre-requisite details is the saved external packet environment details, and generate private key is false, and packet type is EXTERNAL
And I create and upload external packet where source is CRVS1, and packet type is CRVS_DEATH, and parameter 3 is the saved persona file path, and parameter 4 is the saved UIN and store result in second registration ID
And I sync external packet where packet zip path is the saved second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
And I verify notification where notification type is updated, and email is the saved email
...
And I get email by uin where resident uin is the saved child UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I create and upload external packet where source is CRVS1, and packet type is CRVS_DEATH, and parameter 3 is the saved child persona file path, and infotoken is true, and parameter 5 is the saved UIN and store result in second registration ID
And I sync external packet where packet zip path is the saved second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
And I get uin by rid where source registration id is the saved second registration ID and store result in second UIN
And I verify notification where notification type is updated, and email is the saved email
...
And I read pre req where pre requisite data index is 4 and store result in external packet environment details
And I set context where context key is env_context, and pre-requisite details is the saved external packet environment details, and generate private key is false, and packet type is EXTERNAL
And I create and upload external packet where source is CRVS11@invalid, and packet type is CRVS_DEATH1, and parameter 3 is the saved persona file path, and infotoken is true, and parameter 5 is the saved UIN and store result in second registration ID
And I delete packet data
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is rid2
And I get uin by rid where source registration id is rid2 and store result in second UIN
And I verify notification where notification type is updated, and email is email1
And I ekyc bio where device info file is faceDevice, and uin is the saved second UIN, and vid is the saved VID, and persona file path is the saved persona file path
And I delete packet data
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is dob=, and persona file is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is REPROCESS
And I delete packet data
...
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path2
And I update demo or bio details where bio type is iris, and miss fields is 0, and update attributes is 0, and persona to update is persona file path1, and persona to update with is persona file path2
And I update resident with uin where persona file path is persona file path1, and uin is uin1
And I get packet template where packet type is UPDATE, and persona file path is persona file path1 and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is persona file path1, and packet template path is the saved update packet template path and store result in rid3
And I check status where packet status is PROCESSED, and registration id is rid3
And I get uin by rid where source registration id is rid3 and store result in uin3
...
And I get email by uin where resident uin is the saved second UIN and store result in email1
And I verify notification where notification type is UIN Generated, and email is email1
And I update demo or bio details where bio type is rightMiddle, and miss fields is 0, and update attributes is 0, and persona to update is persona file path1, and persona to update with is persona file path2
And I update demo or bio details where bio type is leftThumb, and password is leftRing, and update attributes is 0, and update attributes is 0, and persona to update is persona file path2, and persona to update with is persona file path1
And I update resident with uin where persona file path is persona file path1, and uin is the saved second UIN
And I update resident with uin where persona file path is persona file path2, and uin is uin1
And I get packet template where packet type is UPDATE, and persona file path is persona file path1 and store result in update packet template path
And I get packet template where packet type is UPDATE, and persona file path is persona file path2 and store result in update template2
And I generate and upload packet skipping prereg where persona file path is persona file path1, and packet template path is the saved update packet template path and store result in rid3
And I generate and upload packet skipping prereg where persona file path is persona file path2, and packet template path is update template2 and store result in rid4
And I check status where packet status is PROCESSED, and registration id is rid3
And I check status where packet status is PROCESSED, and registration id is rid4
And I get uin by rid where source registration id is rid3 and store result in uin3
And I verify notification where notification type is updated, and email is the saved email
And I get uin by rid where source registration id is rid4 and store result in uin4
And I verify notification where notification type is updated, and email is email1
Then I check ridstage where registration id is rid3, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
Then I check ridstage where registration id is rid4, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
And I delete packet data
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Right Thumb@@Finger:Right IndexFinger@@Finger:Right MiddleFinger@@Finger:Right RingFinger@@Finger:Right LittleFinger@@
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I get email by uin where resident uin is the saved UIN and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update bio exception in persona where persona file path is the saved persona file path, and biometric exception modalities is Finger:Right Thumb@@Finger:Right IndexFinger@@Finger:Right MiddleFinger@@Finger:Right RingFinger@@Finger:Right LittleFinger@@Finger:Left Thumb@@Finger:Left IndexFinger@@Finger:Left MiddleFinger@@Finger:Left RingFinger@@Finger:Left LittleFinger
And I update resident with uin where persona file path is the saved persona file path, and uin is the saved UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in second registration ID
And I check status where packet status is PROCESSED, and registration id is the saved second registration ID
...
And I update demo or bio details where bio type is iris, and password is finger, and update attributes is 0, and update attributes is 0, and persona to update is the saved child persona file path, and persona to update with is persona file path1
And I update resident with uin where persona file path is the saved child persona file path, and uin is the saved child UIN
And I get packet template where packet type is UPDATE, and persona file path is the saved child persona file path and store result in update packet template path
...
And I get uin by rid where source registration id is rid3 and store result in uin3
And I verify notification where notification type is updated, and email is the saved email
Then I check ridstage where registration id is rid3, and rid stage is BIOGRAPHIC_VERIFICATION, and stage status is FAILED
Then I check ridstage where registration id is rid3, and rid stage is MANUAL_ADJUDICATION, and stage status is SUCCESS
...
And I check status where packet status is PROCESSED, and registration id is rid4
And I get uin by rid where source registration id is rid4 and store result in uin4
And I get email by uin where resident uin is uin4 and store result in email
And I verify notification where notification type is UIN Generated, and email is the saved email
And I update demo or bio details where bio type is iris, and password is finger@@face, and update attributes is 0, and update attributes is 0, and persona to update is the saved persona file path, and persona to update with is persona file path2
And I update resident with uin where persona file path is the saved persona file path, and uin is uin4
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved update packet template path and store result in rid5
And I check status where packet status is REJECTED, and registration id is rid5
Then I check ridstage where registration id is rid5, and rid stage is BIOGRAPHIC_VERIFICATION, and stage status is FAILED
And I delete packet data
...
Given I get ping health where component is packetcreator
And I user where user action is ADD_User, and user index or master user is 219, and password is Techno@123 and store result in user219
And I center where call type is CREATE, and user details is user219, and center index is 219, and center active flag is T and store result in center219
And I machine where call type is CREATE, and center details is center219, and center index is 219 and store result in details219
And I user where user action is DELETE_CENTERMAPPING, and user index or master user is 219, and password is Techno@123, and password or details is details219 and store result in details219
...
And I write pre req where environment details is details219, and pre requisite data index is 219
And I read pre req where pre requisite data index is 219 and store result in details219
And I set context where context key is env_context, and pre-requisite details is details219, and generate private key is true
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I packetcreator where packet type is NEW, and template path is the saved packet template path and store result in packet zip path
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template2 and store result in rid3
And I check status where packet status is PROCESSED, and registration id is rid3
And I get uin by rid where source registration id is rid3 and store result in uin3
And I verify notification where notification type is updated, and email is the saved email
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is gender=Male, and persona file is the saved persona file path
And I update resident with uin where persona file path is the saved persona file path, and uin is uin3
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template3 and store result in rid4
And I check status where packet status is PROCESSED, and registration id is rid4
And I get uin by rid where source registration id is rid4 and store result in uin4
And I verify notification where notification type is updated, and email is the saved email
...
And I update resident with uin where persona file path is the saved persona file path, and uin is uin4
And I get packet template where packet type is UPDATE, and persona file path is the saved persona file path and store result in update template4
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template4 and store result in rid5
And I check status where packet status is PROCESSED, and registration id is rid5
And I get uin by rid where source registration id is rid5 and store result in uin5
And I verify notification where notification type is updated, and email is the saved email
...
And I update resident with uin where persona file path is the saved persona file path, and uin is uin5
...
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is update template5 and store result in rid6
And I check status where packet status is PROCESSED, and registration id is rid6
And I get uin by rid where source registration id is rid6 and store result in uin6
And I get email by uin where resident uin is uin6 and store result in email1
And I verify notification where notification type is updated, and email is email1
And I delete packet data
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is email=empty, and persona file is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is gender=invalid, and persona file is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is dob=29-02-2019, and persona file is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Male and store result in persona file path
And I update demo or bio details where bio type is 0, and miss fields is 0, and update attributes is email=invalidemail, and persona file is the saved persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
And I check status where packet status is REREGISTER, and registration id is the saved registration ID
Then I check ridstage where registration id is the saved registration ID, and rid stage is VALIDATE_PACKET, and stage status is FAILED
...
Given I get ping health where component is packetcreator
And I read pre req where pre requisite data index is 1 and store result in environment 1 details
And I set context where context key is env_context, and pre-requisite details is the saved environment 1 details, and generate private key is false, and invalid schema version is oldIdSchema
And I get ping health where component is targetenv
And I get resident data where persona type is adult, and guardian flag is false, and gender is Female and store result in persona file path
And I get packet template where packet type is NEW, and persona file path is the saved persona file path and store result in packet template path
And I generate and upload packet skipping prereg where persona file path is the saved persona file path, and packet template path is the saved packet template path and store result in registration ID
...
Then I check ridstage where registration id is the saved child registration ID, and rid stage is INTRODUCER_VALIDATION, and stage status is SUCCESS
Then I check ridstage where registration id is the saved child registration ID, and rid stage is VERIFICATION, and stage status is SUCCESS
Then I update demo or bio details where bio type is iris, and password is face@@finger, and update attributes is 0, and persona file is 0, and parameter 5 is the saved child persona file path
...
And I generate and upload packet skipping prereg where persona file path is the saved child persona file path, and packet template path is child template2 and store result in child rid2
Then I check ridstage where registration id is child rid2, and rid stage is INTRODUCER_VALIDATION, and stage status is SUCCESS
Then I check ridstage where registration id is child rid2, and rid stage is VERIFICATION, and stage status is SUCCESS
And I delete packet data
...
And I user where user action is DELETE_User, and user index or master user is dsl-0, and password is Techno@123
