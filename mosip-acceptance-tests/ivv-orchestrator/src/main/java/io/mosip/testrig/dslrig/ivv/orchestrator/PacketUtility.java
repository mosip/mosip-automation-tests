...
//		GlobalMethods.ReportRequestAndResponse("", "", url, jsonwrapper.toString(), response.getBody().asString());
	...
	public String createContexts(String negative, String key, HashMap<String, String> map, 
			...
			String invalidCheckSum , String invalidIdSchemaFlag ,String skipBiometricClassification,String skipApplicantDocuments, String invalidDateFlag, String invalidOfficerIDFlag , String flow , String emptySignature) throws RigInternalError {
		...
		jsonReq.put("signature", emptySignature);
