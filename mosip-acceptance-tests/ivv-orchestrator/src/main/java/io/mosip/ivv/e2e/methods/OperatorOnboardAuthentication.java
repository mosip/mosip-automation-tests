...
public class OperatorOnboardAuthentication extends BaseTestCaseUtil implements StepInterface {
	...
	public void run() throws RigInternalError {
		...
		//uinPersonaProp.put("3465728037", "C:\\Users\\NEEHAR~1.GAR\\AppData\\Local\\Temp\\residents_3672977334853313404\\3536068510.json");
		...
		//String uin="3465728037";
			...
			if (bioResponse != null && !bioResponse.isEmpty() && modalityKeyTogetBioValue!= null) {
					...
					for (Object object : casesList) {
						...
						packetUtility.operatorOnboardAuth(modalityToLog, bioValue, "dsl1", deviceProp, test, bioAuth,"USERID");
				}
			}
		}
	}
