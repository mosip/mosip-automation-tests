			...
			if (bioResponse != null && !bioResponse.isEmpty() && modalityKeyTogetBioValue != null) {
				...
				if (casesListUIN != null) {
					...
					for (Object object : casesList) {
						...
						input = JsonPrecondtion.parseAndReturnJsonContent(input, oidcClientProp.getProperty("urlEncodedResp1"), "encodedHash");
			...
			if (bioResponse != null && !bioResponse.isEmpty() && modalityKeyTogetBioValue != null) {
				...
				if (casesListVID != null) {
					...
					for (Object object : casesList) {
						...
						input = JsonPrecondtion.parseAndReturnJsonContent(input, oidcClientProp.getProperty("urlEncodedResp2"), "encodedHash");
