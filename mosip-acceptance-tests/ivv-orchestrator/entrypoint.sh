...
java --version
java -jar -Denv.user="$USER" -Denv.endpoint="$ENDPOINT" -Denv.testLevel="$TESTLEVEL" -Denv.langcode="$LANG_CODE" -DthreadCount="$THREAD_COUNT" ivv-orchestrator-*-jar-with-dependencies.jar
