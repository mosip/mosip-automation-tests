...
public class CertificateGenerator {
	...
	public static Certificate createMasterCert(PublicKey pubKey, PrivateKey privKey, String issuer, String alias,
	...
	public static X509Certificate createRootCertificate(PublicKey publicKey, PrivateKey privateKey, String issuerString,
			String alias, int validYears) throws Exception {
	...
	public static X509Certificate createIntCertificate(PublicKey publicKey, PrivateKey CAprivateKey,
			X509Certificate rootCertificate, String subjectString, String alias, int validYears)
			throws Exception {
	...
	public static X509Certificate createPartnerCertificate(PublicKey publicKey, PrivateKey CAprivateKey,
			X509Certificate rootCertificate, String subjectString, String alias, int validYears)
			throws Exception {
	...
	public void save() throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException {
		try (FileOutputStream fOut = new FileOutputStream(storeFileName)) {
	...
	public static void main(String[] args) throws Exception {
		...
		X509Certificate c1 = createIntCertificate(intPubKey, caPrivKey, (X509Certificate) chain[2],
				"C=IN, O=EFG Company, OU=Certificate, E=abc@efg.com",
				"Intermediate CA", 3);

		X509Certificate c2 = createPartnerCertificate(pubKey, intPrivKey, c1,
				"C=IN, O=ABC Bank,L=Bangalore,CN=ABC Bank, OU=Account Opening,E=bank@efg.com",
				"Partner Org", 3);
