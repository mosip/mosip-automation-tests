...
import lombok.Data;
@Data
@JsonIgnoreProperties({"labelName","transliteration","visible","label","changeAction","locationHierarchy","transliterate","fieldLayout","groupLabel","templateName","conditionalBioAttributes"})
