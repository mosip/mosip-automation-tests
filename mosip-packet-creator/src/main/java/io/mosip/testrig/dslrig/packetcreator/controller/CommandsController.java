...
public class CommandsController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "Job executed successfully") })
	...
	@Operation(summary = "Upload a file to packet-utility configured folder. API Returns the Path", responses = {
	...
	@Operation(summary = "Update Status of execution", description = "Update the status of an execution identified by the given key. The status can be 'inUse' or 'Free'.", responses = {
	...
	@Operation(summary = "Get Status of execution", description = "Retrieve the status of an execution identified by the given key. The status can be 'inUse' or 'Free'.", responses = {
