 ...
 * @RestController
 * 
 * @Tag(name = "preRegController", description =
 * "REST APIs for Pre Registration") public class RestartController {
 * 
 ...
 * "Successfully restarted the packet creator application") })
 * 
 * @PostMapping("/restart") public void restart() {
